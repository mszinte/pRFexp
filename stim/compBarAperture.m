...
imageMat(round(bar_mask_size / 2 - const.bar_width / 2) - ...
    size(raised_cos, 1):round(bar_mask_size / 2 - ...
    const.bar_width / 2) - 1) = fall_cos'; 
imageMat(round(bar_mask_size / 2 - const.bar_width / 2):...
    round(bar_mask_size / 2 + const.bar_width / 2)) = 0; 
imageMat(round(bar_mask_size / 2 + const.bar_width / 2) + 1:...
    round(bar_mask_size / 2 + const.bar_width / 2) + ...
    size(raised_cos, 1)) = raised_cos'; 
